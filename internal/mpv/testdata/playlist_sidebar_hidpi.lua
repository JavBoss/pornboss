...
local function check_layout(state, logical_width, logical_height, pane_width)
    ...
    assert(state.overlay.data:find("\\fs20", 1, true), "logical font size changed")
    assert(state.overlay.data:find("\\pos(" .. (logical_width - pane_width + 52) .. ",77)", 1, true))
end
